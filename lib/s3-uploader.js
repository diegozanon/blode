...
function getFilesToUpload(config, posts, callback) {
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_HTML_INDEX_PRERENDERED)),
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_HTML_404_PRERENDERED)),
        ContentType: constants.CONTENT_TYPE_HTML,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_ICO_FAVICON)),
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_XML_RSS)),
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_XML_SITEMAP)),
        ContentType: constants.CONTENT_TYPE_XML,
        gzip: true
    });
    ...
    posts.forEach(function(post) {
        ...
        files.push({
            ...
            Body: fs.readFileSync(path.join(config.directory, constants.FOLDER_PARTIALS, partialName)),
            ContentType: constants.CONTENT_TYPE_HTML,
            gzip: true
        });
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_HTML_404)),
        ContentType: constants.CONTENT_TYPE_HTML,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_HTML_POSTS)),
        ContentType: constants.CONTENT_TYPE_HTML,
        gzip: true
    });
    ...
    posts.forEach(function(post) {
        files.push({
            ...
            Body: fs.readFileSync(path.join(config.directory, constants.FOLDER_POSTS, post.url)),
            ContentType: constants.CONTENT_TYPE_HTML,
            gzip: true
        });
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_JS_APP)),
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_JS_CONTROLLERS)),
        ContentType: constants.CONTENT_TYPE_JS,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_JS_DIRECTIVES)),
        ContentType: constants.CONTENT_TYPE_JS,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_JS_NGCLOAK)),
        ContentType: constants.CONTENT_TYPE_JS,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_JS_ROUTES)),
        ContentType: constants.CONTENT_TYPE_JS,
        gzip: true
    });
    ...
    files.push({
        ...
        Body: fs.readFileSync(path.join(config.directory, constants.FILE_CSS_SITE)),
...
function getImagesToUpload(config, callback) {
    ...
    var imagesDir = path.join(config.directory, constants.FOLDER_IMAGES);
    var imagesPostsDir = path.join(config.directory, constants.FOLDER_IMAGES_POSTS);
    var images = [];
...
function getJsAssetsToUpload(config, callback) {
    ...
    var assetsDir = path.join(config.directory, constants.FOLDER_JS_ASSETS);
    var assets = [];
